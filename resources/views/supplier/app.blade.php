...
<div>
    ...
    <div id="header-topbar-option-demo" class="page-header-topbar">
        <nav id="topbar" role="navigation" style="margin-bottom: 0; z-index: 2;" class="navbar navbar-default navbar-static-top">
			...
			<span class="hidden-xs">{{ Session::get('SUPPLIER_ACCESS_FNAME') }}</span>&nbsp;<span class="caret"></span></a>
                        <ul class="dropdown-menu dropdown-user pull-right">
                            <li><a href="{{URL::route('supplier_profile')}}"><i class="fa fa-user"></i>My Profile</a></li>
                            <li><a href="{{ URL::route('supplier_logout') }}"><i class="fa fa-key"></i>Log Out</a></li>
                        </ul>
                    </li>
                </ul>
            </div>
	...
	<div id="wrapper"><!--BEGIN SIDEBAR MENU-->
		...
		<div class="sidebar-collapse menu-scroll">
			...
			<li class="user-panel">
			    ...
			    <div class="info"><p>{{ Session::get('SUPPLIER_ACCESS_FNAME') }}</p>
				<ul class="list-inline list-unstyled">
				    <li><a href="{{URL::route('supplier_profile')}}" data-hover="tooltip" title="Profile"><i class="fa fa-user"></i></a></li>				    
				    <li><a href="{{ URL::route('supplier_logout') }}" data-hover="tooltip" title="Logout"><i class="fa fa-sign-out"></i></a></li>
				</ul>
			    </div>
...
<script src="{{ asset('/backend/vendors/jquery-validate/jquery.validate.min.js') }}"></script>
<script src="{{ asset('/supplier_asset/js/custom_script.js')}}"></script>
<link type="text/css" rel="stylesheet" href="{{ asset('/supplier_asset/css/custom_style.css') }}">
