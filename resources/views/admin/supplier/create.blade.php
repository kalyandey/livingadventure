...
<div class="page-content">
	...
	<div class="col-lg-12">
		...
		<div class="portlet-body">
		    ...
		    {!! Form::open(array('id'=>'createsupplierfrm', 'class' => 'form-horizontal', 'files'=>true, 'route' => array('supplier_master_add'))) !!}                                
					<div class="form-body pal">
						<div class="form-group"><label class="col-md-3 control-label">First Name <span class="require">*</span></label>
	
							<div class="col-md-9">
								{!! Form::text('first_name', '', array('class'=>'required form-control')) !!}
							</div>
						</div>
						<div class="form-group"><label  class="col-md-3 control-label">Last Name <span class="require">*</span></label>
					...
					<div class="form-group form-pass"><label class="col-md-3 control-label">Status </label>
						<div class="col-md-9">
						 {!! Form::select('status', array('Active' => 'Active', 'Inactive' => 'Inactive'),'',array('class'=>'required  form-control')) !!}
						</div>
					</div>
