...
<div id="title-breadcrumb-option-demo" class="page-title-breadcrumb">
 ...
 <!--For breadcrump-->    
  <ol class="breadcrumb page-breadcrumb pull-right">
      ...
      <li><i class="">&nbsp;&nbsp;</i><a href="">Agent</a>
	
      </li>&nbsp;&nbsp; > 
    
      <li><i class="">&nbsp;&nbsp;</i><a href="">Agent Add</a>
...
<!--BEGIN CONTENT-->
        ...
        <div class="col-lg-12">
         <div style="background: transparent; border: 0; box-shadow: none !important;" class="pan mtl mbn responsive">
                        ...
                        {!! HTML::decode(Form::label('email_address', 'Email Address <span class="require">*</span>', array('class' => 'col-md-3 control-label'))) !!}
                            <div class="col-md-4">
                                <div class="input-icon"><i class="fa fa-envelope"></i>
                                    {!! Form::text('email_address', '' , array('class' => 'form-control required email_address','placeholder' => 'Email Address','data-type'=>'email')) !!}
                                </div>
                            </div>
                        </div>
                        <div class="form-group">
