...
$(document).on("focus.autocomplete","#form_airport",function(e){
...
$(document).on("focus.autocomplete","#to_airport",function(e){
...
$('#flight_search').click(function (evento) {
    ...
    var path = "splashs/search_flight?AdtCount=" + Adults + "&DepartureDate="+ DepartureDate +"&FlightType=RoundTrip&From=" + From + "&Method=Search&Page=Result&QFrom=A&QTo=A&ReturnDate=" + ReturnDate + "&To=" + To;
